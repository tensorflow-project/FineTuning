...
Original file is located at
    https://colab.research.google.com/drive/1JFRLEd7iTN71CquGTIWHCwnMNh0jUJFq
"""
...
def training(epoch, model, data, sticker_embedding, cosine_similarity, stable_diffusion):
    ...
    ### Wrap the dataset iterator with tqdm to show progress
        ...
        emb = get_embedding(placeholder_token, stable_diffusion)
